    ...
    async function registrarDispositivoSeNecessario(): Promise<number | null> {
      try {
        ...
        const response = await fetch(
          "https://mivick-project-backend.onrender.com/app/mivick/iot/registrar-dispositivo",
          {
            method: "POST",
            headers: {
    ...
    async function enviarParaBackend(body: Partial<BackendPayload>) {
      try {
        ...
        const response = await fetch("http://10.98.97.162:3000/app/mivick/iot/leituras", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
...
<FirstButton
  ...
  customStyle={{ 
    ...
    width: "85%", 
    alignSelf: "center",
    backgroundColor: "#F85200" // opcional, combina com o tema
  }}
/>
